...
proc create_hier_cell_wave_gen_1 { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 31 -to 0 NCO_freq
...
CONFIG.N_WEIGHTS {8} \
  ...
  connect_bd_net -net nco_driver_2_0_NcoOut_DO [get_bd_pins NCO_freq] [get_bd_pins nco_driver_2_0/NcoOut_DO] [get_bd_pins waveform_gen_0/phase_inc]
...
proc create_hier_cell_wave_gen { parentCell nameHier } {
  ...
  create_bd_pin -dir I Clk_CI
  create_bd_pin -dir I -from 0 -to 0 Div_SI
  create_bd_pin -dir O -from 31 -to 0 NcoOut_DO
  create_bd_pin -dir I -from 31 -to 0 NcoSet_DI
  create_bd_pin -dir I PidEn_SI
  create_bd_pin -dir I -from 31 -to 0 PidIn_DI
  create_bd_pin -dir I PidValid_SI
...
CONFIG.N_WEIGHTS {8} \
  ...
  connect_bd_net -net freq_div_0_OscOut_SO [get_bd_pins SGN_COS] [get_bd_pins freq_div_0/SgnCosOut_SO]
  connect_bd_net -net freq_div_0_SgnSinOut_SO [get_bd_pins SGN_SIN] [get_bd_pins freq_div_0/SgnSinOut_SO]
  connect_bd_net -net nco_driver_2_0_NcoOut_DO [get_bd_pins NcoOut_DO] [get_bd_pins nco_driver_2_0/NcoOut_DO] [get_bd_pins waveform_gen_0/phase_inc]
  connect_bd_net -net waveform_gen_0_cos_out [get_bd_pins waveform_gen_0/cos_out] [get_bd_pins weight_sum_0/A_DI]
  connect_bd_net -net waveform_gen_0_sgn_cos_out [get_bd_pins freq_div_0/SgnCosIn_SI] [get_bd_pins waveform_gen_0/sgn_cos_out]
  connect_bd_net -net waveform_gen_0_sgn_sin_out [get_bd_pins freq_div_0/SgnSinIn_SI] [get_bd_pins waveform_gen_0/sgn_sin_out]
  connect_bd_net -net waveform_gen_0_sin_out [get_bd_pins waveform_gen_0/sin_out] [get_bd_pins weight_sum_0/B_DI]
...
CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_intf_net -intf_net S_AXI4_1 [get_bd_intf_pins S_AXI4] [get_bd_intf_pins axi_gpio_4/S_AXI]
  connect_bd_intf_net -intf_net S_AXI5_1 [get_bd_intf_pins S_AXI5] [get_bd_intf_pins axi_gpio_5/S_AXI]
  ...
  connect_bd_net -net phase_det_Phi_DO [get_bd_pins axi_gpio_5/gpio_io_i] [get_bd_pins phase_det/Phi_DO] [get_bd_pins pid_w_range_0/Din_DI]
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins phase_det/Clk_CI] [get_bd_pins pid_w_range_0/Clk_CI] [get_bd_pins wave_gen/Clk_CI]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn]
  connect_bd_net -net wave_gen_C_DO [get_bd_pins WAVE] [get_bd_pins wave_gen/C_DO]
  connect_bd_net -net wave_gen_NCO_freq [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins wave_gen/NCO_freq]
...
CONFIG.DOUT_WIDTH {8} \
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn]
  connect_bd_net -net wave_gen_C_DO [get_bd_pins WAVE] [get_bd_pins wave_gen/C_DO]
  connect_bd_net -net wave_gen_NcoOut_DO [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins wave_gen/NcoOut_DO]
  connect_bd_net -net wave_gen_Valid_SO [get_bd_pins WAVE_VALID] [get_bd_pins wave_gen/Valid_SO]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins phase_det/Order_DI] [get_bd_pins xlslice_1/Dout]
...
CONFIG.DOUT_WIDTH {14} \
  ...
  connect_bd_intf_net -intf_net soc_M08_AXI [get_bd_intf_pins pll1/S_AXI4] [get_bd_intf_pins soc/M08_AXI]
  connect_bd_intf_net -intf_net soc_M09_AXI [get_bd_intf_pins pll1/S_AXI5] [get_bd_intf_pins soc/M09_AXI]
  connect_bd_intf_net -intf_net soc_M10_AXI [get_bd_intf_pins pll2/S_AXI4] [get_bd_intf_pins soc/M10_AXI]
  connect_bd_intf_net -intf_net soc_M11_AXI [get_bd_intf_pins pll2/S_AXI5] [get_bd_intf_pins soc/M11_AXI]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41300000 [get_bd_addr_spaces soc/processing_system7_0/Data] [get_bd_addr_segs pll2/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg1
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41310000 [get_bd_addr_spaces soc/processing_system7_0/Data] [get_bd_addr_segs pll2/axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg3
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41320000 [get_bd_addr_spaces soc/processing_system7_0/Data] [get_bd_addr_segs pll2/axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg5
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41240000 [get_bd_addr_spaces soc/processing_system7_0/Data] [get_bd_addr_segs pll1/axi_gpio_4/S_AXI/Reg] SEG_axi_gpio_4_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41340000 [get_bd_addr_spaces soc/processing_system7_0/Data] [get_bd_addr_segs pll2/axi_gpio_4/S_AXI/Reg] SEG_axi_gpio_4_Reg1
  create_bd_addr_seg -range 0x00010000 -offset 0x41250000 [get_bd_addr_spaces soc/processing_system7_0/Data] [get_bd_addr_segs pll1/axi_gpio_5/S_AXI/Reg] SEG_axi_gpio_5_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41350000 [get_bd_addr_spaces soc/processing_system7_0/Data] [get_bd_addr_segs pll2/axi_gpio_5/S_AXI/Reg] SEG_axi_gpio_5_Reg1
